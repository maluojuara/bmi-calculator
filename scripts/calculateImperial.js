...
function handleInput() {
    ...
    const feetInput = parseFloat(document.querySelector('#height-ft').value) || 0;
    const inchesInput = parseFloat(document.querySelector('#height-in').value) || 0;
    const stonesInput = parseFloat(document.querySelector('#weight-st').value) || 0;
    const lbsInput = parseFloat(document.querySelector('#weight-lbs').value) || 0;
